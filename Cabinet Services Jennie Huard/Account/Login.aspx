<%@ Page Title="Se connecter" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    CodeBehind="Login.aspx.vb" Inherits="Cabinet_Services_Jennie_Huard.Login" %>
        ...
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                    <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Se connecter" ValidationGroup="LoginUserValidationGroup" OnClick="lala" />
                </p>
            </div>
        </LayoutTemplate>
    </asp:Login>
